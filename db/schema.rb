...
ActiveRecord::Schema.define(version: 20151203211844) do
  ...
  create_table "condition_specialists", force: :cascade do |t|
  ...
  create_table "condition_treatments", force: :cascade do |t|
    t.integer  "condition_id"
